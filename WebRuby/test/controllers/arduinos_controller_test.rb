...
class ArduinosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arduino" do
    assert_difference('Arduino.count') do
      post arduinos_url, params: { arduino: { comando_id: @arduino.comando_id, ip: @arduino.ip } }
    end
  ...
  test "should update arduino" do
    patch arduino_url(@arduino), params: { arduino: { comando_id: @arduino.comando_id, ip: @arduino.ip } }
