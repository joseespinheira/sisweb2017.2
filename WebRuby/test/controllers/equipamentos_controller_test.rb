...
class EquipamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipamento" do
    assert_difference('Equipamento.count') do
      post equipamentos_url, params: { equipamento: { comando_id: @equipamento.comando_id, nome: @equipamento.nome } }
    end
  ...
  test "should update equipamento" do
    patch equipamento_url(@equipamento), params: { equipamento: { comando_id: @equipamento.comando_id, nome: @equipamento.nome } }
